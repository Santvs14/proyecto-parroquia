...
const imagenes = [
  "https://www.palabrasbiblicas.net/wp-content/uploads/sites/19/2025/09/why-spend-time-alone-with-god-e1524313562224.jpg",
  "https://ministeriointernacionalepdd.wordpress.com/wp-content/uploads/2014/02/comunion.jpg",
  "https://www.juventudonline.com/wp-content/uploads/2017/07/comunion2.jpg"
]
  ...
  return (
    <div style={styles.container}>
        ...
        <div style={styles.leftBox}>
          ...
          <div style={styles.leftText}>
            <h2 className="glow">¡¡¡Enamórate de Jesús!!!</h2>
              ...
              <h3 style={{marginTop: "10px", opacity: 0.9}}>
          Carlo Acutis Promueve el amor por Jesús en la Eucaristía
        </h3>
          <button style={styles.button} onClick={() => navigate("/milagroseucaristicos")}>Ver milagros eucarísticos</button>

            <p>
              Ven a ver esto es lo que pasa cuando el sacerdote hace la consagración,
      ...
      <section style={styles.section}>
        <h2 style={styles.centerTitle}>A solas con Dios</h2>
        <div style={styles.grid}>
          {imagenes.map((img, i) => (
            <div key={i} style={styles.imageCard} className="hover">
...
<section style={styles.section}>
  ...
  <div style={styles.comunionPremium}>
